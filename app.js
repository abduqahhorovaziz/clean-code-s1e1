...
var incompleteTaskHolder=document.querySelector(".section__todo");//ul of #incompleteTasks
var completedTasksHolder=document.querySelector(".section__completed");//completed-tasks
